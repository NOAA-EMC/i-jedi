...
namespace ijedi
{
  ...
  // description. Mirrors saber::interpolation::Geometry: a generic path (oops
  // util::setupFunctionSpace) and a GSI-matching custom grid + checkerboard partitioner path.
