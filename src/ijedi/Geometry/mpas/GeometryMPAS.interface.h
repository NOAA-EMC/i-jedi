...
namespace ijedi
{
    extern "C" 
    {
        void ijedi_mpas_geom_setup_f90(void *& geom, const eckit::Configuration &, const eckit::mpi::Comm *);
        ...
        void ijedi_mpas_geom_get_num_nodes_and_elements_f90(const void * geom, int & num_nodes,
                                                       int & num_tris);
        void ijedi_mpas_geom_get_coords_and_connectivities_f90(const void * geom, const int & num_nodes,
        ...
        void ijedi_mpas_geom_get_local_cell_counts_f90(const void * geom, int & nCells, int & nCellsSolve);
